    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-lime-100">
            <form className="flex flex-col bg-cyan-200 rounded-2xl w-80 p-2 space-y-2">
                ...
                <button className="bg-blue-400 self-center w-1/3" onClick={btnRegister}>Registrarse</button>
                <button className="bg-blue-400 self-center w-1/3" onClick={btnLogin}>Login</button>
            </form>
        </div>
    )
}
